...
public class Chessman : MonoBehaviour
{
    ...
    public void OnTriggerEnter2D(Collider2D other)
    {
            ...
            if (other.tag == "Lootbox")
        {
            ...
            GetRandomNumber();
                 if (player == "white" & GetRandomNumber() <= 5 & GetRandomNumber() >= 0)
            {
                controller.GetComponent<Game>().playerWhite[1].SetActive(true);
                SoundManagerScript.PlaySound("PowerUp");
            }
            else if (player == "white" & GetRandomNumber() <= 25 & GetRandomNumber() >= 20)
            {
                controller.GetComponent<Game>().playerWhite[2].SetActive(true);
                SoundManagerScript.PlaySound("PowerUp");
            }
            else if (player == "white" & GetRandomNumber() <= 64 & GetRandomNumber() >= 59)
            {
                controller.GetComponent<Game>().playerWhite[3].SetActive(true);
                SoundManagerScript.PlaySound("PowerUp");
            }
            else if (player == "white" & GetRandomNumber() <= 100 & GetRandomNumber() >= 95)
            {
